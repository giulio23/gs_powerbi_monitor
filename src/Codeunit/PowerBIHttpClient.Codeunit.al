codeunit 90131 "Power BI Http Client"
{
    ...
    /// <returns>The complete API URL</returns>
    // Deprecated: Do not use for service principal/Admin API. Use BuildApiUrl with admin endpoints instead.
    procedure BuildWorkspaceApiUrl(WorkspaceId: Guid; ResourcePath: Text): Text
    begin
        Error('BuildWorkspaceApiUrl is deprecated. Use BuildApiUrl with admin endpoints.');
    end;
