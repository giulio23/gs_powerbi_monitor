codeunit 90136 "Power BI Dashboard Manager"
{
    ...
    begin
        ...
        EndpointUrl := PowerBIHttpClient.BuildApiUrl('admin/dashboards?$filter=workspaceId eq ' + PowerBIHttpClient.FormatGuidForUrl(WorkspaceId));
    ...
    begin
        ...
        // Build API URL for dashboard tiles (Admin endpoint for service principal)
        EndpointUrl := PowerBIHttpClient.BuildApiUrl('admin/dashboards/' + Format(DashboardId) + '/tiles');
